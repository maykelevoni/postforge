...
export default function TemplatesPage() {
  ...
  useEffect(() => {
    // 220px app sidebar + 48px parent padding + 240px templates sidebar = ~520px min useful width
    // Switch to top-nav below 1024px to keep content usable
  ...
  // Pull out of parent padding so sidebar can reach full height
  const bleedOut: React.CSSProperties = {
    margin: "-24px",
  };

  if (isMobile) {
    return (
      <div style={{ ...bleedOut, display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ padding: "24px" }}>
          <div style={headerStyle}>
            ...
            <p style={subtitleStyle}>
              Viral templates for high-performing content
            </p>
          </div>
  ...
  return (
    <div style={{ ...bleedOut, display: "flex" }}>
